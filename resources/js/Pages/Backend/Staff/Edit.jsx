...
const Edit = ({ staff, branches = [], services = [], errors = {} }) => {
  document.title = `Edit ${staff.name} | Admin Panel`

  const { flash } = usePage().props
  const [selectedServices, setSelectedServices] = useState(
    staff.services ? staff.services.map((service) => service.id) : [],
  )
      ...
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            ...
            breadcrumbItems={[
              { title: "Staff", link: "/admin/staff" },
              { title: staff.name, link: `/admin/staff/${staff.slug}` },
            ...
            <Row>
              ...
              <Col lg={12}>
                <div className="text-end mb-4">
                  <Link href={`/admin/staff/${staff.slug}`} className="btn btn-secondary me-2">
                    Cancel
                  </Link>
