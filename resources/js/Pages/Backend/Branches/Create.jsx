...
const Create = ({ managers = [], errors = {} }) => {
  document.title = "Create New Branch | Admin Panel"
    ...
    post("/admin/branches", {
      ...
      onError: (errors) => {
        ...
        if (errors.message) {
          ...
          toast.error("Failed to create branch. Please check the form for errors.")
        }
      },
    })
  }
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Branches" breadcrumbItem="Create Branch" />
            ...
            <Row>
              ...
              <Col lg={12}>
                <div className="text-end mb-4">
                  <Link href="/admin/branches" className="btn btn-secondary me-2">
                    Cancel
                  </Link>
