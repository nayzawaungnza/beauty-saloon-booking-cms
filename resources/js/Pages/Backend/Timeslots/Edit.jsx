...
const Edit = ({ timeslot, staff, branches }) => {
  document.title = `Edit Timeslot - ${timeslot.staff?.name || "Unknown"} | Admin Dashboard`

  const { flash, errors } = usePage().props
  const [formData, setFormData] = useState({
    staff_id: timeslot.staff_id || "",
    branch_id: timeslot.branch_id || "",
    date: timeslot.date || "",
  ...
  const handleSubmit = (e) => {
    ...
    router.patch(`/admin/timeslots/${timeslot.id}`, formData, {
      onSuccess: () => {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Timeslots" breadcrumbItem="Edit Timeslot" />
                ...
                <CardBody>
                  <div className="mb-3">
                    <h5 className="card-title">
                      Edit Timeslot - {timeslot.staff?.name || "Unknown Staff"} ({formatDate(timeslot.date)})
                    </h5>
                    <p className="card-title-desc">Update the timeslot information below.</p>
                  </div>
                  ...
                  <Form onSubmit={handleSubmit}>
                    ...
                    <Row>
                      <Col md="12">
                        <FormGroup className="mb-3">
                          ...
                          <small className="text-muted">Check this if the timeslot is available for bookings.</small>
                        </FormGroup>
                      </Col>
                    </Row>
                    ...
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <Link href={`/admin/timeslots/${timeslot.id}`} className="btn btn-secondary">
