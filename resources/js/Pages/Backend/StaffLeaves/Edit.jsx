...
const Edit = ({ leave, staff }) => {
  document.title = 'Edit Staff Leave | Admin Dashboard';
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    router.put(`/admin/staff-leaves/${leave.id}`, formData);
  };
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Staff Leaves" breadcrumbItem="Edit Staff Leave" />
          <Row>
            <Col lg="12">
              <Card>
                <CardBody>
                  <h5 className="card-title">Edit Staff Leave</h5>
