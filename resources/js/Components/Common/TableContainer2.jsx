...
const pagination = "pagination justify-content-end"
...
const TableContainer2 = ({
  ...
  // Reset pagination only when data changes significantly (not on every render)
  useEffect(() => {
  ...
  }, [data.length, preservePagination])
